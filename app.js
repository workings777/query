...
const WHERE_COLUMNS = [
  ...
  { name: '실적사업소',   type: 'like' },
  { name: '실적대리점',   type: 'like' },
  { name: '소속센터',     type: 'eq' },
  { name: '수주특성',     type: 'eq' },
  { name: '수주건명',     type: 'like' },
  { name: '수주번호',     type: 'eq' },
  { name: '영업건구분',   type: 'dropdown', multi: true,  options: ['일반영업건', '개인영업건', '법인영업건', '프로젝트'] },
  { name: '수주건구분',   type: 'dropdown', multi: true,  options: ['일반수주', '견적수주', '프로젝트수주'] },
  { name: '시공유무',     type: 'dropdown', multi: false, options: ['Y', 'N'] },
  { name: '소비자가',     type: 'num_range' },
  { name: '판매가',       type: 'num_range' },
  { name: '휴대전화',     type: 'eq' },
  { name: '상호명',       type: 'like' },
  { name: '사업자번호',   type: 'eq' },
  { name: '시도',         type: 'eq' },
  ...
  { name: '부가세액',     type: 'num_range' },
  { name: '기준가',       type: 'num_range' },
